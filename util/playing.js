...
module.exports = {
    async play(song, message) {
        ...
        if (!song) {
            sendError(
                "De muziek is gestopt omdat er geen muziek meer in de wachtlijst stond!",
                message.channel
            );
        ...
        let thing = new MessageEmbed()
            .setAuthor("Begonnen met het afspelen van muziek!", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
